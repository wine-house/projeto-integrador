...
const arrayText = ['Trabalhamos em parceria com diversas vinícolas', 'Trabalhamos com vinhos Tinto, Seco, Rose e Espumante', 'Sorteio mensal para participar de eventos gratuitamente', 'Oferecemos diariamente descontos em nossos vinhos', 'Cadastre-se em nosso site e concorra a vários prêmios', 'Ganhe um brinde em sua primeira compra', 'A cada 10 compras, ganhe um kit de vinhos', 'Sempre disponibilizamos vinhos de ótima qualidade'];
let counter = 0;
